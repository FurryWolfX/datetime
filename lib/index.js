class Datetime {
  ...
  static formatTimeToSeconds(v_time) {
  ...
  static dateDiff(timestamp, timestampEnd) {
    // 补全为13位
  ...
  static unitToTimestamp(value, unit) {
    let _value = 0;
    switch (unit) {
      case "week":
